...
namespace CrossOverAssignment.Security
{
    public class AuthConfig
    {
        ...
        public static void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(StockTickerDbContext.Create);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<IdentityConfig.ApplicationUserManager, User>(
